package com.example.kernelstyleuikit.ui.component.miuix
...
import com.example.kernelstyleuikit.ui.component.dialog.LoadingDialogHandle
import com.example.kernelstyleuikit.ui.util.getBugreportFile
        ...
        content = {
            ...
            ArrowPreference(
                ...
                onClick = {
                    ...
                    exportBugreportLauncher.launch("KernelStyleUIKit_bugreport_${current}.txt.gz")
                    onDismissRequest()
                },
